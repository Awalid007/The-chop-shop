      ...
      <main>
          ...
          <div className="container mx-auto px-6">
            <div className="flex flex-col lg:flex-row items-center gap-16">
              <div className="lg:w-1/2">
                <h2 className="text-zeal font-black uppercase tracking-[0.3em] text-[10px] mb-4">Professionalism</h2>
                <h3 className="text-3xl md:text-5xl font-extrabold uppercase leading-tight text-slate-900 mb-8">
                  PREMIUM BARBER SERVICES DELIVERED AT POLARIS
                </h3>
                <p className="text-slate-500 leading-relaxed mb-10 max-w-lg font-medium">
                  Experience the ultimate convenience and luxury of personalized grooming. From classic cuts to modern styles, our expert barbers bring the best of the salon to your neighborhood.
                </p>
                <div className="flex gap-12">
                   <div>
                      <span className="block text-4xl font-extrabold text-slate-900 mb-1">98%</span>
                      <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Client Satisfaction</span>
                   </div>
                   <div className="border-l border-slate-100 pl-12">
                      <span className="block text-4xl font-extrabold text-slate-900 mb-1">12+</span>
                      <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Years Excellence</span>
                   </div>
                </div>
              </div>
              <div className="lg:w-1/2">
                 <div className="relative">
                    <img src="https://images.unsplash.com/photo-1593702295094-ada74bc4a169?auto=format&fit=crop&q=80&w=2070" className="rounded-3xl zeal-shadow relative z-10" alt="Barbering" />
        ...
        <section className="relative py-32 bg-slate-900 overflow-hidden">
          <div className="absolute inset-0 opacity-20">
             <img src="https://images.unsplash.com/photo-1503951914875-452162b0f3f1?auto=format&fit=crop&q=80&w=2070" className="w-full h-full object-cover" />
          </div>
          <div className="container mx-auto px-6 relative z-10 text-center">
             <h3 className="text-2xl md:text-4xl font-extrabold uppercase text-white mb-8 max-w-3xl mx-auto leading-tight">
               INDULGE IN PREMIUM BARBERING SERVICES FROM THE CONVENIENCE OF POLARIS
             </h3>
        ...
        <section className="py-24 bg-white border-b border-slate-100">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
               <h3 className="text-3xl font-extrabold uppercase text-slate-900 mb-4">WHY VA CHOP SHOP?</h3>
               <p className="text-slate-400 uppercase font-bold tracking-widest text-[10px]">Expertise, Luxury, and Modern Convenience</p>
            </div>
