    ...
    <footer className="bg-white py-20 border-t border-slate-100">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-bold tracking-widest uppercase text-slate-900">THE CHOP SHOP</span>
            </div>
            <p className="text-slate-400 text-sm max-w-sm leading-relaxed italic mb-6">
              "We take pride in our work and ensure that every guest who walks through our doors leaves looking and feeling their best."
            </p>
            <div className="text-slate-500 text-xs font-semibold leading-loose">
              <p>2769 Richmond Hwy Ste 105</p>
              <p>Stafford, VA 22554</p>
              <p className="mt-2 text-zeal hover:underline"><a href="tel:5403006232">(540) 300-6232</a></p>
            </div>
          </div>
          <div>
        ...
        <div className="pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">
          <span>© 2024 THE CHOP SHOP • STAFFORD, VA</span>
